...
The discovery orchestration, OSM index, persistence layer, React workspace, repository, desktop runtime, model manager, and outreach controls are Leadroom-specific. Leadroom is an independent community project and is not an official ScrapeGraphAI product or endorsed by its maintainers.

See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) for upstream and data-source attribution.
